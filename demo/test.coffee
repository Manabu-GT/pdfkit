...
# Table Api Demo
data = [['00:01', '00:50', '210km', '120km', '05:30', '01:20']]
for i in [0..15]
  data.push(['00:01', '00:50', i * 10 + 'km', '120km', '05:30', '01:20'])
...
#these two lines are required to use japanese font
#doc.font('fonts/ipaexg.ttf')
#this is a hack to prevent a bug that the 13th character somehow gets replaced by 10th character
#doc.fontSize(0).text("1234567890ab`", 0, 0, {width: 0, align: 'left'})

doc.fontSize(12).text('2013/8/20',
...
#this is a hack to prevent a bug that the 13th character somehow gets replaced by 10th character
doc.fontSize(0).text("1234567890ab`", 0, 0, {width: 0, align: 'left'})
doc.table(data, headers, options)
